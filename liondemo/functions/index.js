...
const HOSTING_URL = 'https://liondemo2017.firebaseapp.com';
...
function getRandomNumber (min, max) {
  ...
  admin.database().ref('/number').set(n);
  return n
}


function releaseCandies () {
  console.log('activating machine...');
  //TODO: activate machine

  admin.database().ref('/activate').set({"won": { ".sv": "timestamp" }});
...
const CORRECT_GUESS_PROMPTS = ['Well done! It is indeed %s. You can get your candies now!', 'Congratulations, that\'s it! I was thinking of %s. Pick some candies here!',
  'You got it! It\'s %s. This candies are for you.' ];
...
const GREETING_PROMPTS = ['Let\'s play Lion Demo!', 'Welcome to Lion Demo!', 'Hi! This is Lion Demo.',
  'Welcome back to Lion Demo.'];
...
const FALLBACK_PROMPT_1 = ['Are you done playing Lion Demo?'];
...
const DEEPLINK_PROMPT_3 = ['Wow! You\'re a genius! %s has %s letters and the number I was thinking of was %s! Well done!',
  'Amazing! You\'re a genius! %s has %s letters and the number I was thinking of was %s. Great job!'];
...
const IMAGE = {
  ...
  INTRO: {url: IMAGE_BASE_URL + '/INTRO.gif', altText: 'Mystical crystal ball', description: 'Welcome to Lion Demo!'},
...
exports.manual = functions.https.onRequest((request, response) => {
  releaseCandies();
  response.send("Get candies!");
